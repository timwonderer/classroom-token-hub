...
## I. Purpose
To define the remediation requirements and ongoing preventative guidelines concerning the PromptPwnd vulnerability within GitHub Actions AI workflows.

## II. Scope
All automated CI/CD workflows utilizing AI agent inferences.
