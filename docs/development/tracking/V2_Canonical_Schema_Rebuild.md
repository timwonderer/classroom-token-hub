...
- Retire `V2_BACKWARDS_COMPATIBILITY_CLEANUP.md`, `V2_Class_Scope_Normalization_Target.md`, `V2_STUDENT_BLOCKS_REDESIGN_NOTE.md`, `V2_ADMIN_ROUTE_REFACTOR.md` — all superseded by this rebuild. Move to `docs/development/archive/`.
