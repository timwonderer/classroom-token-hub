...
| Live-test migration rehearsal | `done` | `SOP-DEP-022_V2_Live_Test_Runbook.md`, `LOG-ARC-050_V2_Live_Test_Rehearsal_Report_04032026.md` | 2026-04-03 rehearsal reached `2bde3e5f00ac (head)`, completed upgrade/current checks, passed PostgreSQL validation, and recorded final `GO` after remediation | Re-run only if new launch-critical app, migration, or test-code changes land before live testing |
