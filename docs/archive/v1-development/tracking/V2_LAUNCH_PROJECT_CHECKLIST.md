...
- `docs/TRACKING/V2_PARALLEL_WORKSTREAMS.md`
- `docs/TRACKING/V2_DOCUMENTATION_COMPLIANCE_SWEEP.md`
- `docs/SPECS/V2_ADMIN_ROUTE_REFACTOR.md`
- `docs/SPECS/V2_Class_Scope_Normalization_Target.md`
- `docs/SPECS/V2_CLASS_ID_INVARIANT_BACKLOG.md`
- `docs/TRACKING/V2_BACKWARDS_COMPATIBILITY_CLEANUP.md`
- `docs/SPECS/V2_STUDENT_IDENTITY_ARCHITECTURE.md`
- `docs/archive/v1-development/TABLE_CONSOLIDATION_ANALYSIS.md`
- `docs/archive/v1-development/LEGACY_SCHEMA_ANALYSIS.md`
