...
- **[v1.8.0](RELEASE_NOTES_v1.8.0.md)** - Rent item types, coverage tracking, stability fixes (February 8, 2026)
- **[v1.7.1](RELEASE_NOTES_v1.7.1.md)** - Financial precision fixes, payroll stability (January 25, 2026)
- **[v1.7.0](RELEASE_NOTES_v1.7.0.md)** - Analytics Dashboard, Rent Itemization, Mobile Navigation (January 9, 2026)
- **[v1.6.0](RELEASE_NOTES_v1.6.0.md)** - Repository Organization and Stability (December 31, 2025)
...
- **[v1.1.1](RELEASE_NOTES_v1.1.1.md)** - Bug fixes for authentication, theming, and redirects (December 14, 2025)
- **[v1.1.0](RELEASE_NOTES_v1.1.0.md)** - Dashboard analytics, projection graphs, and UI redesign (December 13, 2025)
- **[v1.0.0](RELEASE_NOTES_v1.0.md)** - Initial stable release (December 11, 2025)
