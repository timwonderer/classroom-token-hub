...
roles: [teacher]
description: Configure savings interest, overdraft rules, and banking behavior.
keywords: [banking, interest, savings, overdraft]
related:
  - user-guides/features/teacher/banking/managing-banking
  - user-guides/features/teacher/banking/transactions
...
- [Transactions](/docs/user-guides/features/teacher/banking/transactions)
