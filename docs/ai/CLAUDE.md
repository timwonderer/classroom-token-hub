...
- **Project History:** `../project/PROJECT_HISTORY.md` for context and philosophy
- **Development Priorities:** `../development/DEVELOPMENT.md` for roadmap and planned features
