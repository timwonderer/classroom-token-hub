...
This directory contains the canonical documentation for the Classroom Token Hub, organized by namespace per [SOP-DOC-000](sop/SOP-DOC-000_Writing_Specification.md).

---

## Document Tier Classification

All documents are classified into one of three tiers. See [SOP-DOC-000 Section V](sop/SOP-DOC-000_Writing_Specification.md) for full definitions.
...
- **[Documentation Standard](sop/SOP-DOC-000_Writing_Specification.md)** — Tier classification, taxonomy, naming, authoring rules
- **[Documentation Index](sop/SOP-DOC-002_Documentation_Index.md)** — Complete list of tracked documents
