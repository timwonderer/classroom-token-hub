...
## 3. Mandatory Checklist (PR-Blocking)

All items below MUST be checked before merge.

### 3.1 Expand / Contract Compliance
...
## 4. Enforcement Mechanism (How This Becomes PR-Blocking)

This gate is enforced through **process and automation**:

### 4.1 Process Enforcement
...
**Status:** Active, PR‑blocking policy
