...
- **[Migration Specifications](../DATABASE/SOP-DB-011_migration_specifications.md)** - Database schema migrations
...
4. Review recent changes in [CHANGELOG.md](../../LOGS/RELEASES/LOG-REL-002_CHANGELOG_MIRROR.md)
