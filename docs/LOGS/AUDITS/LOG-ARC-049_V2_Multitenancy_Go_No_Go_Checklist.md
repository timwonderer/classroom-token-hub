...
Main-branch feature reconciliation now lives in `docs/TRACKING/V2_MAIN_RECONCILIATION_TRACKER.md`. Keep this historical checklist focused on the 2026-03-08 go/no-go snapshot and use the new tracker for current parity decisions.
