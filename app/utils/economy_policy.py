...
def get_transaction_tier_defaults(
    ...
    *,
    ...
    if base_premium is not None:
        ...
        resolved_base_premium = (Decimal(str(cwi)) * weekly_premium_rate).quantize(Decimal("0.01"))
