...
Verifies that the sum of POSTED transactions per (student, join_code, account_type)
matches the values stored in BalanceCache. A mismatch indicates silent corruption
of the balance cache or a bug in the settlement path.
"""
