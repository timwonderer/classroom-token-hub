...
def rent():
    ...
    # CRITICAL: Convert to float to avoid Decimal type mixing
    checking_balance = float(student.get_checking_balance(teacher_id=teacher_id, join_code=join_code))
    savings_balance = float(student.get_savings_balance(teacher_id=teacher_id, join_code=join_code))
