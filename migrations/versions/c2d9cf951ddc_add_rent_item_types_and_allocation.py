...
def upgrade():
    ...
    with op.batch_alter_table('rent_items', schema=None) as batch_op:
        batch_op.add_column(sa.Column('rent_item_type', sa.String(length=20), nullable=False))
    ...
    with op.batch_alter_table('store_items', schema=None) as batch_op:
        batch_op.add_column(sa.Column('is_rent_linked', sa.Boolean(), nullable=False))

    with op.batch_alter_table('student_blocks', schema=None) as batch_op:
        batch_op.add_column(sa.Column('rent_hall_passes', sa.Integer(), nullable=False))
